...
The module can also be used in r, using the reticulate package. The easiest way is to source a python script with reticulate
...
.. code-block:: r
    ...
    source_python('python_example.py')

It is also possible to load the package into R and use the functions inside of an R script.
